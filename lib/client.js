...
/**
 *
 * @param {String} canBroadCast
 * Set broadcast for the socket.
 */
SsdpClient.prototype.setBroadcast = function(canBroadCast) {
	if (!this.sock) {
		this._logger('Socket is closed.');
		return;
	}

	this._setBroadcast(canBroadCast);
}
